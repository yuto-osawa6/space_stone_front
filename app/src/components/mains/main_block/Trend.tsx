...
import { GridProductItemTrend } from "./trend/GridProductItemTrend"
...
export const Trend:React.FC<Props> = memo(function ThisSeasonAnimeInfomationFunc(Props){
