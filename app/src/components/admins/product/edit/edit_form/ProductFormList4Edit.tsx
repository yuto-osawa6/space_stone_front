...
export const ProductFormList4Edit:React.FC<Props> = (Props) => {
  ...
  const [characterIdList,setCharacterIdList] = useState<selectOption[]>(Props.formProduct.formStaff)
...
const [genresIdList,setGenresIdList] = useState<selectOption[]>(Props.formProduct.formStudio)
